...
<div id="add">
    <a href="javascript:void(0)">添加功能</a>
    <input type='hidden' value="<?php echo U('Function/add');?>"/>
    <a href="<?php echo U('Function/index');?>">返回功能列表</a>
</div>
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr style="height:35px; line-height: 35px; overflow:hidden;">
	    		...
	    		<td>
	    			...
	    			<input type="hidden" value="<?php echo U('Function/detail', array('id'=>$v[id]));?>">
	    		</td>
	    		...
	    		<td>
	    			...
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('Function/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Function/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>
